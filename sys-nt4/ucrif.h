...
/*
 * Return the number of bytes ready to be read from the channel. At
 * least this many bytes can be read, maybe more by the time you get
 * to it. This call does not block. Under Linux, the call would look
 * like this:
 *
 *    int count = ioctl(fd, UCR_NREAD, 0);
 *
 * The count gets loaded with the size, or -1 if there is an error.
 */
# define UCR_NREAD UCR_(0,7)
...
/*
 * Reset the board. This causes any boot operations on the target
 * board to happen.
 *
 ...
 *
 * Revision 1.23  1998/04/13 20:48:48  steve
 *  Get debug flags by ioctl.
 *
 * Revision 1.22  1998/04/07 22:06:12  steve
 *  More tracing support.
 *
 * Revision 1.21  1998/04/03 01:35:13  steve
 *  Add assertion support.
 *
 * Revision 1.20  1998/04/01 00:23:06  steve
 *  Support partial reads.
 *
 * Revision 1.19  1998/03/23 19:54:22  steve
 *  More careful testing.
 *
 * Revision 1.18  1998/03/23 03:30:25  steve
 *  non-blocking reading under NT.
 *
 * Revision 1.17  1998/03/23 00:07:38  steve
 *  initial frame support for winnt.
 *
 * Revision 1.16  1998/03/11 00:07:17  steve
 *  Support non-blocking input, and add an ioctl
 *  that tests for input data.
 *
 * Revision 1.15  1998/01/29 22:00:07  steve
 *  Flush writes when read blocks.
 *
 * Revision 1.14  1997/12/07 02:16:43  steve
 ...
 *
 * Revision 1.13  1997/12/02 02:29:04  steve
 *  Add support for ISE board reset.
 *
 * Revision 1.12  1997/11/11 11:19:46  steve
 *  Add support for frames.
 *
 * Revision 1.11  1997/09/11 21:58:36  steve
 *  Port the uCR device driver to Windows NT,
 *  make the configure select the target board
 *  and target host interface headers.
 *
 * Revision 1.10  1997/08/18 21:53:46  steve
 *  Support inline channel commands.
 *
 * Revision 1.9  1997/06/16 05:14:50  steve
 *  New channel protocol design and implementation.
 *
 * Revision 1.8  1997/03/06 23:27:31  steve
 *  Add specific trace bits for ucr driver tracing,
 *  Simplify the frame allocation to use only pages.
 *
 * Revision 1.7  1997/03/05 03:34:36  steve
 *  Fix major bugs in frame handling.
 *
 * Revision 1.6  1997/03/03 22:00:48  steve
 *  Reuse frame if possible.
 *
 * Revision 1.5  1997/02/28 03:28:22  steve
 *  Add to the ucr linux driver support for a frame buffer,
 *  and add to the BUS class support for is as well.
 *
 *  The linux driver uses GNU style autoconf for configuration
 *  and install.
 *
 * Revision 1.4  1996/10/28 03:46:58  steve
 *  License notice.
 *
 * Revision 1.3  1996/10/09 18:37:34  steve
 *  The ucr driver now prevents file descriptors opening
 *  opened channels. Document this fact.
 *
 *  Polish documentation for release, and add copyright
 *  notices that were missing.
 *
 * Revision 1.2  1996/09/08 17:12:30  steve
 *  Add attention capability.
 *
 * Revision 1.1  1996/09/03 23:43:07  steve
 *  Add the cyclone linux driver.
 *
 */
